...
// Storer defines the principal data access contract.
...
type Storer interface {
	...
	List(ctx context.Context, filter FilterList, orderBy fop.Order, page fop.PageStringCursor, forPrevious bool) ([]Principal, error)
	Get(ctx context.Context, principalID string) (Principal, error)
	Create(ctx context.Context, input CreatePrincipal) (Principal, error)
	Update(ctx context.Context, principalID string, input UpdatePrincipal) (Principal, error)
...
// Repository provides business logic for Principals.
