...
// Storer defines the user_password data access contract.
...
type Storer interface {
	...
	List(ctx context.Context, filter FilterList, orderBy fop.Order, page fop.PageStringCursor, forPrevious bool) ([]UserPassword, error)
	Get(ctx context.Context, userID string) (UserPassword, error)
	Create(ctx context.Context, input CreateUserPassword) (UserPassword, error)
	Update(ctx context.Context, userID string, input UpdateUserPassword) (UserPassword, error)
...
// Repository provides business logic for UserPasswords.
...
// NewRepository creates a new UserPassword repository.
