// Package verificationcodesbridge provides HTTP routes for VerificationCode operations.
...
// AddHttpRoutes registers all HTTP routes for VerificationCode operations.
