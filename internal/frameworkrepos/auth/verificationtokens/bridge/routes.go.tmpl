// Package verificationtokensbridge provides HTTP routes for VerificationToken operations.
...
// AddHttpRoutes registers all HTTP routes for VerificationToken operations.
