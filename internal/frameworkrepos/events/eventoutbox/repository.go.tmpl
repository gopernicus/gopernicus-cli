...
// Storer defines the event_outbox data access contract.
...
type Storer interface {
	...
	List(ctx context.Context, filter FilterList, orderBy fop.Order, page fop.PageStringCursor, forPrevious bool) ([]EventOutbox, error)
	Get(ctx context.Context, eventID string) (EventOutbox, error)
	Create(ctx context.Context, input CreateEventOutbox) (EventOutbox, error)
	Update(ctx context.Context, eventID string, input UpdateEventOutbox) (EventOutbox, error)
...
// Repository provides business logic for EventOutboxes.
...
// NewRepository creates a new EventOutbox repository.
