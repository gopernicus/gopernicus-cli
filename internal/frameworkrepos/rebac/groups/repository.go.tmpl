...
// Storer defines the group data access contract.
...
type Storer interface {
	...
	List(ctx context.Context, filter FilterList, orderBy fop.Order, page fop.PageStringCursor, forPrevious bool) ([]Group, error)
	Get(ctx context.Context, groupID string) (Group, error)
	Create(ctx context.Context, input CreateGroup) (Group, error)
	Update(ctx context.Context, groupID string, input UpdateGroup) (Group, error)
	SoftDelete(ctx context.Context, groupID string) error
	Archive(ctx context.Context, groupID string) error
	Restore(ctx context.Context, groupID string) error
...
// Repository provides business logic for Groups.
