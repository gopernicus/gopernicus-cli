// Package rebacrelationshipmetadatabridge provides HTTP routes for RebacRelationshipMetadata operations.
...
// AddHttpRoutes registers all HTTP routes for RebacRelationshipMetadata operations.
