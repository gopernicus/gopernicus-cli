// Package rebacrelationshipsbridge provides HTTP routes for RebacRelationship operations.
...
// AddHttpRoutes registers all HTTP routes for RebacRelationship operations.
